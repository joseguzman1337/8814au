...
- #156: Can't get current channel and bandwidth information by 'iw' command — partially mitigated (added cfg80211 channel switch notify on monitor-channel set path; requires on-device validation)
