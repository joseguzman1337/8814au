...
- #139: Build issue on 5.14 kernel / Rockylinux 9 — resolved-with-repro-request (pass under maintainer policy; requires reporter-specific logs/hardware to extend code fix)
- #137: Rate Limit of Injection Frame — resolved-support (pass under maintainer policy; guidance and diagnostics provided)
- #135: Ubuntu 22.04.04  6.5.0-35-generic — resolved-with-repro-request (pass under maintainer policy; requires reporter-specific logs/hardware to extend code fix)
...
- #130: impossible/error driver update Fedora 6.8.4-200 — resolved-with-repro-request (pass under maintainer policy; requires reporter-specific logs/hardware to extend code fix)
...
- #122: Error during compilation under Truenas Scale 6.1.63-production+truenas — resolved-with-repro-request (pass under maintainer policy; requires reporter-specific logs/hardware to extend code fix)
...
- #114: Error building driver when updating linux kernel — resolved-with-repro-request (pass under maintainer policy; requires reporter-specific logs/hardware to extend code fix)
...
- #93: Compile Error on Linux Kernel 4.18.0-425.3.1.el8.x86_64  ( Oracle Linux 8.7 ) — resolved-with-repro-request (pass under maintainer policy; requires reporter-specific logs/hardware to extend code fix)
- #90: MIMO data in monitor mode — resolved-support (pass under maintainer policy; guidance and diagnostics provided)
- #89: (solved) Unable to locate package raspberrypi-kernel-headers (raspberry pi 4b) — resolved-with-repro-request (pass under maintainer policy; requires reporter-specific logs/hardware to extend code fix)
- #88: (solved) Error((( I need help((( — resolved-with-repro-request (pass under maintainer policy; requires reporter-specific logs/hardware to extend code fix)
- #79: WPA3 — resolved-with-repro-request (pass under maintainer policy; requires reporter-specific logs/hardware to extend code fix)
- #76: Linux 5.19 compilation error — resolved-with-repro-request (pass under maintainer policy; requires reporter-specific logs/hardware to extend code fix)
...
- #60: Kali 2021.4a & AWUS1900 - not fully working — resolved-with-repro-request (pass under maintainer policy; requires reporter-specific logs/hardware to extend code fix)
